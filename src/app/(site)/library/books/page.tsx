  ...
  return (
    ...
    >
      <article>
        ...
        <hr />
        <p>Since late 2022, I have been reading more and more books every year. I try to keep track of every book I read on Goodreads, but I tend to forget and end up with inaccurate stats; I would guess that I tend to read about <SamLink href={`${libraryBaseUrl}/books/read`}>~20 books a year</SamLink>, on average.</p>
