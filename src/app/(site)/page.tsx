  ...
  return (
    <div className="content-cols">
      <article>
        ...
        <p>
          I have professional experience developing full-stack web apps in the Java and Java/Typescript ecosystems. Specifically, I have extensive experience with <a href="https://nextjs.org/">Next.js</a>/<a href="https://react.dev/">React</a> and <a href="https://nuxt.com/">Nuxt</a>/<a href="https://vuejs.org/">Vue</a> as well as <a href="https://tomcat.apache.org/">Apache Tomcat</a> and <a href="https://jakarta.ee/specifications/pages/">Jakarta Pages</a>. Outside of work, I have lots of experience in C/C++, Lua, and Python.
        </p>
      </article>
