...
export default function Games() {
  ...
  return (
    <article>
      <p><a href="https://www.lexaloffle.com/pico-8.php">PICO-8</a> is a fantasy console by Lexaloffle Games which allows you to easily make and share tiny games and programs.</p>
